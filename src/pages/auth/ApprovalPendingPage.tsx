    ...
    <RootLayout>
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
          ...
          {/* 문의 섹션 */}
          <div className="w-full bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-xl p-5">
        ...
        {/* 하단 고정 버튼 영역 */}
        <div className="px-6 pb-safe pb-6 flex flex-col gap-3">
          <Button
