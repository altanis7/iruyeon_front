...
export function ClientDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="h-dvh w-full bg-slate-50 max-w-md mx-auto overflow-y-auto scrollbar-hide shadow-[0_0_20px_#0000000d] pt-safe-top">
  ...
  if (!client) {
    return (
      <div className="h-dvh w-full flex items-center justify-center bg-slate-50 max-w-md mx-auto shadow-[0_0_20px_#0000000d] pt-safe-top">
