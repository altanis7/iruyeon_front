...
const BottomSheetFooter = ({
  ...
  <SheetFooter className={cn("flex-col sm:flex-col", className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <SheetTitle ref={ref} className={cn(className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SheetDescription ref={ref} className={cn(className)} {...props} />
));
